...
#ifndef __SCIP_READER_CBP_H__
#define __SCIP_READER_CBP_H__
...
class ReaderCBP : public scip::ObjReader
{
public:

	/** default constructor */
	ReaderCBP(SCIP* scip)
		: scip::ObjReader(scip, "reader", "file reader for Conic Binpack files", "cbp")
	{}
