...
void solve_conic_knap_approx(
	...
	while(true){
		...
		quad_estimator.get_right_slope(),  quad_estimator.get_ub(), algo_conf, sol_pool,  sol_val_rel,  sol_ub_rel ,mu_val_rel, b_val_rel,  sol_type_rel,  timelimit ,  target_lb); // solve the relaxation
